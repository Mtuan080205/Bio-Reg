--[[
    Zrxx Hub - Blox Fruits Full Sea 1, 2, 3 Quest System
    Tên Menu: Zrxx Hub
    Bản sửa lỗi bổ sung đầy đủ tất cả nhiệm vụ và quái vật cho cả 3 Sea.
--]]

-- ==========================================
-- 1. KHỞI TẠO THƯ VIỆN GIAO DIỆN RAYFIELD UI
-- ==========================================
...
local Window = Rayfield:CreateWindow({
   ...
   LoadingSubtitle = "Hệ thống Full Quest Sea 1, 2, 3",
...
-- ==========================================
-- 3. HÀM KIỂM TRA LEVEL & QUEST TOÀN DIỆN (FULL SEA 1, 2, 3)
-- ==========================================
function CheckLevel()
    local myLevel = Player.Data.Level.Value
    
    -- ------------------------------------------
    -- LỰA CHỌN THEO SEA 1 (PlaceId: 2753915549)
    -- ------------------------------------------
    ...
    -- ------------------------------------------
    -- LỰA CHỌN THEO SEA 2 (PlaceId: 4442272125)
    -- ------------------------------------------
    elseif game.PlaceId == 4442272125 or (myLevel >= 700 and myLevel < 1500) then
        ...
        elseif myLevel >= 875 and myLevel <= 924 then
            -- Bãi quái mốc cấp độ 905 hiện tại của bạn
    ...
    -- ------------------------------------------
    -- LỰA CHỌN THEO SEA 3 (PlaceId: 7405815058)
    -- ------------------------------------------
    elseif game.PlaceId == 7405815058 or myLevel >= 1500 then
        ...
        elseif myLevel >= 1975 and myLevel <= 2199 then
            ...
            -- Mốc quái cấp độ cao nhất cho Sea 3
...
-- ==========================================
-- 4. HÀM TỰ ĐỘNG LẤY VŨ KHÍ TỪ BALO (BACKPACK)
-- ==========================================
function EquipTool()
...
-- ==========================================
-- 5. HÀM TỰ ĐỘNG ĐÁNH NHANH (FAST ATTACK)
-- ==========================================
...
-- ==========================================
-- 8. CÁC NÚT TƯƠNG TÁC TRÊN GIAO DIỆN MENU
-- ==========================================
